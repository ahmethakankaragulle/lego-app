...
<body class="antialiased">
    ...
    <div class="container px-5 py-5">
        ...
        <div class="filter py-1 d-flex flex-row justify-content-start">
            ...
            <div class="input-group d-flex flex-column">
                <p class="text-primary mb-0 w-0">Mesaj Durumu</p>
                <select class="form-select" style="width:190px;">
                    <option selected>Tümü</option>
                    <option value="1">Cevaplananlar</option>
        ...
        <div class="messages mt-5">
            ...
            <div class="message bg-white shadow d-flex flex-row mb-2">
                ...
                <div class="p-3 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-primary btn-sm" href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $message->email }}&su=Cevap: {{ $message->message }}" target="_blank"><img src="storage/icons/mail-right-arrow-svgrepo-com.svg" height="20px" alt="Mesaj Gönder"></a>
